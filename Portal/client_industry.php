 ...
 */
    ...
    class client_industryPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Client Industry');
            $this->SetMenuLabel('Client Industry');
    ...
    try
    {
        $Page = new client_industryPage("client_industry", "client_industry.php", GetCurrentUserPermissionsForPage("client_industry"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("client_industry"));
