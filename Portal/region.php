 ...
 */
    ...
    class regionPage extends Page
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'RegionName', 'RegionName', 'Region Name'),
                new FilterColumn($this->dataset, 'Description', 'Description', 'Description'),
                new FilterColumn($this->dataset, 'Address', 'Address', 'Address'),
                new FilterColumn($this->dataset, 'PostalAddress', 'PostalAddress', 'Postal Address'),
                new FilterColumn($this->dataset, 'TelNum', 'TelNum', 'Tel Num'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['RegionName'])
                ->addColumn($columns['Description'])
                ->addColumn($columns['Address'])
                ->addColumn($columns['PostalAddress'])
                ->addColumn($columns['TelNum'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('RegionName');
            ...
            $main_editor = new TextEdit('PostalAddress');
            ...
            $main_editor = new TextEdit('TelNum');
            ...
            $main_editor = new TextEdit('Website');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('RegionName', 'RegionName', 'Region Name', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for PostalAddress field
            //
            $column = new TextViewColumn('PostalAddress', 'PostalAddress', 'Postal Address', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            ...
            //
            // View column for TelNum field
            //
            $column = new TextViewColumn('TelNum', 'TelNum', 'Tel Num', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
        ...
        {
            //
            // Edit column for RegionName field
            //
            $editor = new TextAreaEdit('regionname_edit', 50, 8);
            $editColumn = new CustomEditColumn('Region Name', 'RegionName', $editor, $this->dataset);
            ...
            //
            // Edit column for PostalAddress field
            //
            $editor = new TextAreaEdit('postaladdress_edit', 50, 8);
            $editColumn = new CustomEditColumn('Postal Address', 'PostalAddress', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            
            //
            // Edit column for TelNum field
            //
            $editor = new TextAreaEdit('telnum_edit', 50, 8);
            $editColumn = new CustomEditColumn('Tel Num', 'TelNum', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new regionPage("region", "region.php", GetCurrentUserPermissionsForPage("region"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("region"));
