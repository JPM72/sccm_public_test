 ...
 */
    ...
    class sales_orgPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Sales Org');
            $this->SetMenuLabel('Sales Org');
    ...
    try
    {
        $Page = new sales_orgPage("sales_org", "sales_org.php", GetCurrentUserPermissionsForPage("sales_org"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sales_org"));
