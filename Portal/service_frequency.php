 ...
 */
    ...
    class service_frequency_quotePage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_service_frequency_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('service_frequency', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_service_frequency_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_contract_duration_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('contract_duration', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_contract_duration_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_site_quoted_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('site_quoted', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_site_quoted_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_sales_org_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('sales_org', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_sales_org_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_sales_division_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('sales_division', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_sales_division_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_region_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('region', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_region_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_sales_district_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('sales_district', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_sales_district_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_service_frequency_quote_profit_center_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('profit_center', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_service_frequency_quote_profit_center_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Service Frequency', 'service_frequency', 'service_frequency_frequency', 'edit_service_frequency_quote_service_frequency_search', $editor, $this->dataset, $lookupDataset, 'id', 'frequency', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Contract Duration', 'contract_duration', 'contract_duration_duration', 'edit_service_frequency_quote_contract_duration_search', $editor, $this->dataset, $lookupDataset, 'id', 'duration', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Site Quoted', 'site_quoted', 'site_quoted_site_name', 'edit_service_frequency_quote_site_quoted_search', $editor, $this->dataset, $lookupDataset, 'id', 'site_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Sales Org', 'sales_org', 'sales_org_name', 'edit_service_frequency_quote_sales_org_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Division', 'sales_division', 'sales_division_name', 'edit_service_frequency_quote_sales_division_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Region', 'region', 'region_RegionName', 'edit_service_frequency_quote_region_search', $editor, $this->dataset, $lookupDataset, 'Id', 'RegionName', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Sales District', 'sales_district', 'sales_district_DistrictName', 'edit_service_frequency_quote_sales_district_search', $editor, $this->dataset, $lookupDataset, 'Id', 'DistrictName', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Profit Center', 'profit_center', 'profit_center_name', 'edit_service_frequency_quote_profit_center_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('frequency', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Service Frequency', 'service_frequency', 'service_frequency_frequency', 'multi_edit_service_frequency_quote_service_frequency_search', $editor, $this->dataset, $lookupDataset, 'id', 'frequency', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('duration', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Contract Duration', 'contract_duration', 'contract_duration_duration', 'multi_edit_service_frequency_quote_contract_duration_search', $editor, $this->dataset, $lookupDataset, 'id', 'duration', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('site_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Site Quoted', 'site_quoted', 'site_quoted_site_name', 'multi_edit_service_frequency_quote_site_quoted_search', $editor, $this->dataset, $lookupDataset, 'id', 'site_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Org', 'sales_org', 'sales_org_name', 'multi_edit_service_frequency_quote_sales_org_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Division', 'sales_division', 'sales_division_name', 'multi_edit_service_frequency_quote_sales_division_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('RegionName', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Region', 'region', 'region_RegionName', 'multi_edit_service_frequency_quote_region_search', $editor, $this->dataset, $lookupDataset, 'Id', 'RegionName', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DistrictName', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales District', 'sales_district', 'sales_district_DistrictName', 'multi_edit_service_frequency_quote_sales_district_search', $editor, $this->dataset, $lookupDataset, 'Id', 'DistrictName', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Profit Center', 'profit_center', 'profit_center_name', 'multi_edit_service_frequency_quote_profit_center_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('frequency', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Service Frequency', 'service_frequency', 'service_frequency_frequency', 'insert_service_frequency_quote_service_frequency_search', $editor, $this->dataset, $lookupDataset, 'id', 'frequency', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('duration', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Contract Duration', 'contract_duration', 'contract_duration_duration', 'insert_service_frequency_quote_contract_duration_search', $editor, $this->dataset, $lookupDataset, 'id', 'duration', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('site_name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Site Quoted', 'site_quoted', 'site_quoted_site_name', 'insert_service_frequency_quote_site_quoted_search', $editor, $this->dataset, $lookupDataset, 'id', 'site_name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Org', 'sales_org', 'sales_org_name', 'insert_service_frequency_quote_sales_org_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Division', 'sales_division', 'sales_division_name', 'insert_service_frequency_quote_sales_division_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('RegionName', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Region', 'region', 'region_RegionName', 'insert_service_frequency_quote_region_search', $editor, $this->dataset, $lookupDataset, 'Id', 'RegionName', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DistrictName', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales District', 'sales_district', 'sales_district_DistrictName', 'insert_service_frequency_quote_sales_district_search', $editor, $this->dataset, $lookupDataset, 'Id', 'DistrictName', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Profit Center', 'profit_center', 'profit_center_name', 'insert_service_frequency_quote_profit_center_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('frequency', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_service_frequency_search', 'id', 'frequency', null, 20);
            ...
            $lookupDataset->setOrderByField('duration', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_contract_duration_search', 'id', 'duration', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('site_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_site_quoted_search', 'id', 'site_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_sales_division_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('RegionName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_region_search', 'Id', 'RegionName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DistrictName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_sales_district_search', 'Id', 'DistrictName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_service_frequency_quote_profit_center_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('frequency', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_service_frequency_search', 'id', 'frequency', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('duration', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_contract_duration_search', 'id', 'duration', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('site_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_site_quoted_search', 'id', 'site_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_sales_division_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('RegionName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_region_search', 'Id', 'RegionName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DistrictName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_sales_district_search', 'Id', 'DistrictName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_service_frequency_quote_profit_center_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('frequency', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_service_frequency_search', 'id', 'frequency', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('duration', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_contract_duration_search', 'id', 'duration', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('site_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_site_quoted_search', 'id', 'site_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_sales_division_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('RegionName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_region_search', 'Id', 'RegionName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DistrictName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_sales_district_search', 'Id', 'DistrictName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_service_frequency_quote_profit_center_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('frequency', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_service_frequency_search', 'id', 'frequency', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('duration', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_contract_duration_search', 'id', 'duration', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('site_name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_site_quoted_search', 'id', 'site_name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_sales_division_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('RegionName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_region_search', 'Id', 'RegionName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DistrictName', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_sales_district_search', 'Id', 'DistrictName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_service_frequency_quote_profit_center_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class service_frequencyPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Service Frequency');
            $this->SetMenuLabel('Service Frequency');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('service_frequency.quote')->HasViewGrant() && $withDetails)
            {
            //
            // View column for service_frequency_quote detail
            //
            $column = new DetailColumn(array('id'), 'service_frequency.quote', 'service_frequency_quote_handler', $this->dataset, 'Quote');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new service_frequency_quotePage('service_frequency_quote', $this, array('service_frequency'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('service_frequency.quote'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('service_frequency.quote'));
            $detailPage->SetHttpHandlerName('service_frequency_quote_handler');
            $handler = new PageHTTPHandler('service_frequency_quote_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new service_frequencyPage("service_frequency", "service_frequency.php", GetCurrentUserPermissionsForPage("service_frequency"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("service_frequency"));
