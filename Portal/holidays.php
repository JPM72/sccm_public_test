 ...
 */
    ...
    class holidaysPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Holidays');
            $this->SetMenuLabel('Holidays');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'holiday_date', 'holiday_date', 'Holiday Date'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['holiday_date'])
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new DateTimeEdit('holiday_date_edit', false, 'Y-m-d');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for holiday_date field
            //
            $column = new DateTimeViewColumn('holiday_date', 'holiday_date', 'Holiday Date', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for holiday_date field
            //
            $editor = new DateTimeEdit('holiday_date_edit', false, 'Y-m-d');
            $editColumn = new CustomEditColumn('Holiday Date', 'holiday_date', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
    ...
    try
    {
        $Page = new holidaysPage("holidays", "holidays.php", GetCurrentUserPermissionsForPage("holidays"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("holidays"));
