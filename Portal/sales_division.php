 ...
 */
    ...
    class sales_divisionPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Sales Division');
            $this->SetMenuLabel('Sales Division');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_sales_division_sales_org_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('sales_org', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sales_division_sales_org_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Sales Org', 'sales_org', 'sales_org_name', 'edit_sales_division_sales_org_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Org', 'sales_org', 'sales_org_name', 'multi_edit_sales_division_sales_org_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sales Org', 'sales_org', 'sales_org_name', 'insert_sales_division_sales_org_search', $editor, $this->dataset, $lookupDataset, 'Id', 'name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sales_division_sales_org_search', 'Id', 'name', null, 20);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sales_division_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sales_division_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sales_division_sales_org_search', 'Id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new sales_divisionPage("sales_division", "sales_division.php", GetCurrentUserPermissionsForPage("sales_division"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sales_division"));
