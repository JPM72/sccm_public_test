 ...
 */
    ...
    class service_typePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Service Type');
            $this->SetMenuLabel('Service Type');
    ...
    try
    {
        $Page = new service_typePage("service_type", "service_type.php", GetCurrentUserPermissionsForPage("service_type"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("service_type"));
